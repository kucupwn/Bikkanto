...
Some day I might come back to this project to rework the frontend part with React, but right now I am happy that it works, despite the code is spaghetti and inconsistent.
